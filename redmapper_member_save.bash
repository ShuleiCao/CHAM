#!/bin/bash
#SBATCH -J redmapper_members_save
#SBATCH -o "slurm_outputs/redmapper_members_save_%j.out"
#SBATCH -N 1
#SBATCH -n 1
...
python /users/shuleic/scripts/pythonscripts/All_other_useful_tools/match_redmapper_Cardinal/redmapper_member_save.py
